...
"summary": "CZON 是一个 AI-Native 的 Markdown 内容引擎，旨在帮助内容创作者专注于写作，减少配置和翻译的负担。它通过 AI
  技术自动处理多语言翻译、摘要提取、标签分类和智能导航，让用户用母语写作即可生成多语言版本。CZON
  内置静态站点生成功能，但强调其核心是内容创作而非复杂定制，适合希望简化工作流程的创作者。"
"tags":
  - "AI"
  - "Markdown"
  - "内容引擎"
