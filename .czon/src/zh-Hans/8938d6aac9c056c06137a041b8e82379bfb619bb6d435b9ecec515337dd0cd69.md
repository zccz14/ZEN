...
'summary': '这是一个用于验证 CZON 中 Mermaid 图表渲染功能的测试文件。文档包含了多种 Mermaid
  图表类型的示例，包括流程图、序列图、甘特图、类图、状态图和饼图，并提供了一个错误语法测试案例。这些示例展示了不同图表的结构和语法，旨在测试 Mermaid
  集成的正常工作。文档以中文编写，内容简洁明了，适合用于功能验证和示例参考。'
'tags':
  - 'Mermaid'
  - '图表测试'
  - '流程图'
